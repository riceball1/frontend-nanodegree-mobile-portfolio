...
var pizzaElementGenerator = function(i) {
    ...
    pizzaImage.src = "images/pizza.min.png"; // changed to minified pizza
...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        ...
        // moved newwidth function inside of changePizzaSizes
        var newwidth = 0;
        // reassign pizza sizes directly
        switch (size) {
            case "1":
                newwidth = "25%";
                break;
        ...
        // pull variable out and used getElementsByClassName
...
function updatePositions() {
    ...
    // use getElementsByClassName for faster access to DOM
